...
/* harmony import */ var _button_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);




Object(_select__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "btnClick2", function() { return btnClick2; });
...
let btnClick = document.querySelector(".button").addEventListener('click', () => {
...
let btnClick2 = document.querySelector(".button2").addEventListener('click', () => {
            let money = document.querySelector(".manyNumber");
            let many = Number(money.textContent);
